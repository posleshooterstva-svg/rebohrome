...
export const BALANCE_POLICY_SUMMARY = [
  "Platform balance is intended for purchases on ReboHrome.",
  "Balance is not withdrawable unless ReboHrome expressly enables such functionality in the future.",
  "Suspicious balance activity may require compliance review.",
  "Fraud, abuse, and chargeback activity may lead to account restrictions.",
];
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Telegram usernames may be used for transaction linking, support communication, fraud prevention, and account recovery assistance.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "ReboHrome is intended only for users aged 18 years or older.",
      ],
    },
    {
      title: "12. Contact",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Chargeback abuse or fraudulent disputes may result in account suspension, permanent restrictions, and balance limitations.",
      ],
    },
    {
      title: "8. Shipping",
      paragraphs: [
        ...
        "Estimated delivery time is 7вЂ“21 business days depending on destination.",
...
export const refundPolicyDocument: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      title: "Shipping",
      paragraphs: [
        "Estimated international delivery is 7вЂ“21 business days.",
    ...
    },
    {
      title: "Agreement",
      paragraphs: [
        "By completing a purchase or deposit, users agree to platform rules, refund limitations, compliance procedures, and digital delivery conditions.",
      ],
    },
    {
      title: "Contact",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "The platform monitors deposits, purchases, balance activity, login activity, and payment attempts to help prevent fraud, abuse, and unauthorized use.",
      ],
    },
    {
      title: "Suspicious Activity Detection",
      paragraphs: [
        "Accounts, transactions, or balance activity that appear inconsistent, abusive, or high-risk may be placed under review before completion.",
      ],
    },
    {
      title: "Transaction Reviews",
      paragraphs: [
        "ReboHrome may delay, reject, or manually review deposits, balance activity, and collectible transfers when additional verification is required.",
      ],
    },
    {
