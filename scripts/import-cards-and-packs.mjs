...
const PACKS = [
  {
    ...
    title: "Starter PokГ©mon Gacha Pack",
    rarity: "Rare",
    price: 49,
    stock: 50,
    description:
  ...
  },
  {
    ...
    title: "Water PokГ©mon Gacha Pack",
    rarity: "Epic",
    price: 199,
    stock: 30,
    description:
  ...
  },
  {
    ...
    title: "Legendary PokГ©mon Gacha Pack",
    rarity: "Legendary",
    price: 499,
    stock: 15,
    description:
  ...
  },
  {
    ...
    title: "Grail PokГ©mon Gacha Pack",
    rarity: "Legendary",
    price: 1499,
    stock: 8,
    description:
...
function buildCardProduct(entry, idx) {
  ...
  return {
    ...
    collection: "PokГ©mon", category: "Trading Card",
...
function buildPack(p) {
  ...
  return {
    ...
    collection: "PokГ©mon", category: "Gacha Pack",
    ...
    deliveryPhysical: "The physical graded card is sealed and shipped from ReboHrome's fulfillment vault with tracking.",
